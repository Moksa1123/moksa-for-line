...
use Moksa\Line\Template\TemplateMessages;
...
<div class="wrap moksa-line-wrap">
	<h1><?php esc_html_e( 'Template messages', 'moksa-line' ); ?></h1>

	<p class="description">
		<?php esc_html_e( 'Fixed layouts with buttons, for when a card is all you need and a Flex design is more than you want to build.', 'moksa-line' ); ?>
	</p>
	...
	<div class="moksa-split moksa-split--wide">
		<div class="moksa-split__main">
			<form class="moksa-panel" data-moksa-template-form>
				<h2>
					<?php esc_html_e( 'Template', 'moksa-line' ); ?>
				...
				<div class="moksa-field-row">
					<p>
						<label for="moksa-template-name"><?php esc_html_e( 'Template name', 'moksa-line' ); ?></label>
						<input type="text" id="moksa-template-name" name="name" class="widefat" required />
					</p>

					<p>
						<label for="moksa-template-alt"><?php esc_html_e( 'Fallback text', 'moksa-line' ); ?></label>
						<input type="text" id="moksa-template-alt" name="alt_text" class="widefat" maxlength="1500" required />
						<span class="description"><?php esc_html_e( 'Shown in the chat list and in push notifications, where the card cannot be drawn.', 'moksa-line' ); ?></span>
					</p>
				</div>

				<p>
					<label for="moksa-template-kind"><?php esc_html_e( 'Kind', 'moksa-line' ); ?></label>
				...
				<div class="moksa-template-shape" data-moksa-template-shape hidden>
					<span class="description"><?php esc_html_e( 'These apply to every card. LINE refuses a carousel whose cards are not built the same way.', 'moksa-line' ); ?></span>
					<span class="moksa-template-shape__row">
						<label><input type="checkbox" data-moksa-shape="image" /> <?php esc_html_e( 'Cards have an image', 'moksa-line' ); ?></label>
						<label><input type="checkbox" data-moksa-shape="title" checked /> <?php esc_html_e( 'Cards have a title', 'moksa-line' ); ?></label>
						<label>
							<?php esc_html_e( 'Buttons per card', 'moksa-line' ); ?>
				...
				<p data-moksa-template-add hidden>
					<button type="button" class="button" data-moksa-add-template-card><?php esc_html_e( '+ Add a card', 'moksa-line' ); ?></button>
				</p>

				<div class="moksa-preview-warnings" data-moksa-template-warnings></div>

				<p>
					<label for="moksa-template-json"><?php esc_html_e( 'Template JSON', 'moksa-line' ); ?></label>
					...
					<button type="button" class="button-link" data-moksa-toggle-template-json><?php esc_html_e( 'Edit the JSON directly', 'moksa-line' ); ?></button>
				</p>

				<p>
					<button type="submit" class="button button-primary"><?php esc_html_e( 'Save template', 'moksa-line' ); ?></button>
					<button type="button" class="button" data-moksa-template-check><?php esc_html_e( 'Check', 'moksa-line' ); ?></button>
					<button type="button" class="button" data-moksa-reset-template><?php esc_html_e( 'New template', 'moksa-line' ); ?></button>
				</p>

				<p>
					<label for="moksa-template-test"><?php esc_html_e( 'Send a test to', 'moksa-line' ); ?></label>
					<input type="text" id="moksa-template-test" class="regular-text" placeholder="U1234..." data-moksa-template-test-target />
					<button type="button" class="button" data-moksa-template-test><?php esc_html_e( 'Send test', 'moksa-line' ); ?></button>
		...
		<div class="moksa-split__side">
			<div class="moksa-panel">
				...
				<p class="description">
					<?php esc_html_e( 'Drawn as the customer receives it. The exact fonts and corners are LINE\'s, not this preview\'s.', 'moksa-line' ); ?>
				</p>
				...
				<ul class="moksa-list">
					...
					<?php foreach ( $templates as $template ) : ?>
						<li data-template='<?php echo esc_attr( (string) wp_json_encode( $template ) ); ?>'>
							...
							<button type="button" class="button-link delete" data-moksa-delete-template="<?php echo esc_attr( (string) $template->id ); ?>"><?php esc_html_e( 'Delete', 'moksa-line' ); ?></button>
						</li>
					<?php endforeach; ?>
				</ul>
			</div>
