...
class Moksa_Line_Database {
    ...
    public function create_tables() {
        ...
        // Users Table
        $sql_users = "CREATE TABLE {$this->table_name} (
        ...
        // Quick Replies Table
        $table_quick_replies = $wpdb->prefix . 'moksa_line_quick_replies';
        ...
        // Auto Replies Table
        $table_auto_replies = $wpdb->prefix . 'moksa_line_auto_replies';
        ...
        // Imagemaps Table
        $table_imagemaps = $wpdb->prefix . 'moksa_line_imagemaps';
        $sql_imagemaps = "CREATE TABLE $table_imagemaps (
            id bigint(20) NOT NULL AUTO_INCREMENT,
        ...
        dbDelta($sql_auto_replies);
        dbDelta($sql_imagemaps);
    }
